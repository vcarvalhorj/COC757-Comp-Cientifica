...
#3) Steepest Descent precondicionado
...
x =steepest_descent(A, M, b_vet, x0)            #solucao numérica aproximada
...
plt.figure('Figura 2')
plt.scatter(xc,x[0],marker = '*', color = 'r')
plt.title('Steep. Descent precond.')
